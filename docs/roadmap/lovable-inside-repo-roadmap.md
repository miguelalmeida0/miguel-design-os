...
Why it matters: Embedded `.design-os` support is stronger when every new project starts with the same local workflow folders.

Files/folders required:

- `templates/project-template/`
- `templates/project-template/.design-os/README.md`
...
- Creates a target project skeleton with `.design-os` usage documented.
