...
export const qaRuns: QaRun[] = [
  {
    ...
    status: "blocked",
    playwrightStatus: "blocked",
    captureMode: "blocked",
    browserRequested: "auto",
    blockedReason: "Playwright/Chromium automation may fail or be unavailable; run the doctor, then use Chrome/WebKit/tmpdir fallback or manual app-only import.",
    ...
    blockers: [
      { id: "visual-capture", text: "Screenshot proof is missing. Automated capture preferred; manual app-only import is acceptable fallback.", resolved: false }
    ],
    doneReportStatus: "ready",
    doneReportFinalStatus: "needs-work",
    scoreCurrent: 60,
    scoreTarget: 80,
